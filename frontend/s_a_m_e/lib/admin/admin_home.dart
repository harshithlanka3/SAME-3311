...
import 'package:s_a_m_e/account/edit_signs.dart';
import 'package:s_a_m_e/account/edit_symptoms.dart';
            ...
            ListTile(
              ...
              onTap: () {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => const ViewAccounts(),
                    ));
              },
            ),
            ListTile(
        ...
        child: Column(
          children: <Widget>[
            ...
            ElevatedButton(
              ...
              child: const Text('Get Potential Diagnosis',
                  style:
                      TextStyle(fontWeight: FontWeight.bold, fontSize: 16.0)),
              onPressed: () {
                Navigator.push(
            ...
            ElevatedButton(
              ...
              child: const Text('Diagnosis List',
                  style:
                      TextStyle(fontWeight: FontWeight.bold, fontSize: 16.0)),
              onPressed: () {
                Navigator.push(
