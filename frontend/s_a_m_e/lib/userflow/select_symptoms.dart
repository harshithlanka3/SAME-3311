              ...
              builder: (context, snapshot) {
                if (snapshot.connectionState == ConnectionState.waiting) {
                  ...
                  return Column(
                    children: [
                      const Text(
                        "Select symptoms from the categories below",
                                                      ...
                                                      children: [
                                                        CheckboxListTile(
                                                            ...
                                                            title: Text(snapshot
                                                                    .data![index]
                                                                    .symptoms[
                                                                index2]), // this gets symptom name
                                                            // contentPadding: const EdgeInsets.all(5),
                                                            activeColor: teal,
                                                            value: checkedSymptoms[
                                                                    snapshot
                                                                        .data![
                                                                            index]
                                                                        .symptoms[index2]]![
      ...
      floatingActionButton: ElevatedButton(
        style: const ButtonStyle(
          ...
          backgroundColor: MaterialStatePropertyAll<Color>(
              navy), // idk what color to make this
        ),
        child: const Text('Get Potential Diagnoses',
        ...
        onPressed: () {
          Navigator.push(
              ...
              MaterialPageRoute(
                builder: (context) =>
                    PotentialDiagnosis(selectedSymptoms: checkedSymptoms),
              ));
        },
      ),
