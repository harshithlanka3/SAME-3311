...
class DiagnosisPage extends StatefulWidget {
  const DiagnosisPage(
      {super.key, required this.diagnosis, required this.title});
                                  ...
                                  children: <TextSpan>[
                                    const TextSpan(
                                        ...
                                        style: TextStyle(
                                            fontWeight: FontWeight.bold)),
                                    TextSpan(
                                        text: ": Organ system shall go here")
                                  ]),
                            ),
                            const SizedBox(
                              height: 15,
                                ...
                                child: ListView.builder(
                                    ...
                                    itemBuilder: (context, index) {
                                      return Row(children: [
                                        ...
                                        Expanded(
                                          child: Text(
                                            widget.diagnosis.symptoms[index],
                                            style:
                        ...
                        children: [
                          ...
                          RichText(
                            text: TextSpan(
                                ...
                                children: <TextSpan>[
                                  TextSpan(
                                      text: ": ${widget.diagnosis.nextSteps}")
                                ]),
                          ),
                        ],
                      ),
